...
void RldpIn::collect(metrics::MetricsPromise P) {
  ...
  set.families.push_back(MetricFamily::make_scalar("parts_sent_to_adnl_total", "counter",
                                                   load(metrics_->parts_sent_to_adnl),
  ...
  set.families.push_back(MetricFamily::make_scalar("connections_active", "gauge",
